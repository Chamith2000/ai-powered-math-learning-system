...
const SearchPage = () => {
  ...
  const fetchVideoLectures = async () => {
    try {
      const { data } = await apiClient.get("/api/maths/video-lectures/");
  ...
  const fetchPapers = async () => {
    try {
      const { data } = await apiClient.get("/api/maths/papers");
      const items = Array.isArray(data) ? data : [];
      setPapers(items);
                          ...
                          <div className="post-item style-2">
                            <div className="post-inner">
                              <div className="post-content">
                                <Link to={`/maths-lectures/${lecture._id}`}>
                                ...
                                <Link to={`/maths-lectures/${lecture._id}`} className="lab-btn">
                                  <span>
