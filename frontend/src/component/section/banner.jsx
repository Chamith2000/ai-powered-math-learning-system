...
const subTitle = "Online Maths education";
const title = <h2 className="title"><span className="d-lg-block">Learn The</span>Maths Skills You Need <span className="d-lg-block">To Succeed</span></h2>;
const desc = "Best Free Maths lerning Platform's in the World";
                            ...
                            <div className="banner-content">
                                ...
                                <form onSubmit={handleSearchSubmit}>
                                    ...
                                    <input
                                        type=""
                                        // type="text"
                                        placeholder="Search Maths Lectures"
                                        value={searchQuery}
