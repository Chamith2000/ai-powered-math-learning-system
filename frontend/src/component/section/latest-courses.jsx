...
const LatestCourse = () => {
  ...
  const difficultyLevel = useMemo(() => {
    ...
    console.log("LatestCourse: difficultyLevel from localStorage:", dl);
  ...
  // Helper: does this lecture match the user's difficulty?
                    ...
                    <div className="course-item">
                      <div className="course-inner">
                        <div className="course-thumb" style={{ position: "relative" }}>
                          ...
                          <Link to={`/course-view/${lecture._id}`} className="d-block w-100">
                            {lecture.videoUrl ? (
                              <video
