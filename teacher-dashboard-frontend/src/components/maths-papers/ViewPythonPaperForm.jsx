...
const ViewPythonPaperForm = ({ title }) => {
  ...
  const verdictText = (p) => {
    if (p >= 0.5) return 'Needs re-teach';
    if (p >= 0.25) return 'Review recommended';
    return 'Healthy';
  };
...
export default ViewPythonPaperForm;
