...
const UpdateMathsPaperForm = ({ title }) => {
  ...
  const deleteExistingQuestion = async (idx) => {
    ...
    try {
      ...
      const token = getToken();
      await axios.delete(`${BASE_URL}/maths/qanda/${q._id}`, {
        headers: { Authorization: `Bearer ${token}` },
      });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.put(`${BASE_URL}/maths/papers/${id}`, payload, {
        headers: {
          Authorization: `Bearer ${token}`,
          'Content-Type': 'application/json',
        },
                  ...
                  <div className="row g-3">
                    <div className="col-md-8">
                      ...
                      <input
                        ...
                        placeholder="Explain Maths list comprehensions with an example"
                      />
                    </div>
                ...
                <div className="row g-3">
                  <div className="col-md-8">
                    ...
                    <input
                      ...
                      placeholder="What is Maths's list 'append' vs 'extend'?"
                    />
                  </div>
...
export default UpdateMathsPaperForm;
