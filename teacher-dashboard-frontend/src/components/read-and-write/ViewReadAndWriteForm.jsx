...
const ViewReadAndWriteForm = ({ title }) => {
  ...
  const creator = useMemo(() => {
    if (!paper) return {};
    // If backend later adds creator fields, these will populate;
    // otherwise this gracefully shows blanks.
  ...
  const runAnalysis = async () => {
    ...
    try {
      ...
      Swal.fire('Error', 'Failed to analyze this paper.', 'error');
    } finally {
      setAnalyzing(false);
    }
  };
          ...
          <div className="d-flex flex-wrap justify-content-between align-items-center gap-2 mb-3">
            <div className="d-flex align-items-center gap-2">
              ...
              <button
                ...
                onClick={runAnalysis}
                disabled={analyzing || loadingPaper || loadingQuestions}
              >
              ...
              <div className="row g-3 mb-4">
                ...
                <div className="col-md-3">
                  <div className="p-3 border rounded text-center">
                    ...
                    <div className="fs-4 fw-bold">{analysis.ConfusingQuestions?.length || 0}</div>
                  </div>
                </div>
                <div className="col-md-3">
                  <div className="p-3 border rounded text-center">
                    <div className="text-muted small">Weak Topics</div>
                    <div className="fs-4 fw-bold">{analysis.WeakTopics?.length || 0}</div>
                  </div>
                </div>
                <div className="col-md-3">
                  <div className="p-3 border rounded text-center">
...
export default ViewReadAndWriteForm;
