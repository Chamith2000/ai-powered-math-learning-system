...
const AddPythonLectureForm = ({ title }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await Swal.fire({
        icon: 'success',
        title: 'Lecture added!',
        text: 'Python video lecture was created successfully.',
        timer: 1700,
      ...
      Swal.fire({
        ...
        text:
          ...
          'Failed to add Python video lecture.',
      });
    } finally {
...
export default AddPythonLectureForm;
