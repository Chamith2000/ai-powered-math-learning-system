...
const UpdateMathsLectureForm = ({ title }) => {
  ...
  const fetchLecture = async () => {
    try {
      const token = getToken();
      const res = await axios.get(`${BASE_URL}/maths/video-lectures/${id}`, {
        headers: { Authorization: `Bearer ${token}` },
      });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.put(`${BASE_URL}/maths/video-lectures/${id}`, fd, {
        headers: {
...
export default UpdateMathsLectureForm;
