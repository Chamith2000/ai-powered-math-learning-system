...
def predict_emotion_from_dataurl(image_dataurl: str):
    ...
    if len(faces) == 0:
        return ("No Face", 0.0)   # matches your frontend check intent
...
@app.route("/object-classes", methods=["GET"])
def get_object_classes():
    """
    Returns the dictionary of all classes the YOLO model can identify.
    """
    try:
        return jsonify({
